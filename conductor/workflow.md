...
> Customized for gotham — TouchBistro Go utility library.
...
This workflow can be customized during `/conductor:setup`:

| Setting | Default | Options |
|---------|---------|---------|
| Coverage Target | **90%** | 70%, 80%, 90%, 100% |
| Commit Strategy | **Per Phase** | Per Task, Per Phase |
